# statml study hub - linear algebra

a collaboratively curated repository compiling and synthesizing playlists and resources on foundational mathematics for artificial intelligence contributors are encouraged to engage critically and refine the material

---

## table of contents
- [Linear Algebra, Fall 2011 - Strang](#linear-algebra-fall-2011---strang)
- [Linear Algebra - Strang, Recent](#linear-algebra-strang-recent)
- [18.06 Linear Algebra, Spring 2010 - Strang](#1806-linear-algebra-spring-2010---strang)
- [Introduction to Linear Algebra - 3Blue1Brown](#introduction-to-linear-algebra-3blue1brown)
- [Chapter 1, Essence of Linear Algebra](#chapter-1-essence-of-linear-algebra)
- [18.06 SC Linear Algebra, Fall 2011 - Strang](#1806-sc-linear-algebra-fall-2011---strang)
- [Linear Algebra - Professor Dave Explains](#linear-algebra-professor-dave-explains)
...
## student workflow
- open the repository directly on GitHub, not from local files  
- watch videos from the playlists, starting with statistical mathematics for machine learning  
- each student summarizes the video they finish  
- upload the summary as a markdown file or PDF on the repository  
- follow daily updates to track progress  
- collaboration is encouraged; students may create a private WhatsApp or Discord group if needed  
- aim to finish all videos within one month  
- the most important thing is to summarize and practice actively, using pen and paper  
- for any questions, contact the supervisor or team members
